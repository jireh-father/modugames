...
- **에이밍: 조작부 왼쪽 원형 조이스틱으로 조준점 이동** (비례 속도 방식)
- 조이스틱을 기울인 방향과 크기에 비례하여 조준점이 이동
- 웹: 조이스틱 드래그 / 모바일: 터치 조이스틱 (추후 자이로 센서)
...
**발사 플로우:**
1. 슬라이드를 아래로 드래그 후 놓기 → 약실 장전 (매 발사 후 수동)
2. 방아쇠를 뒤로 드래그 → 발사!
3. 발사 후 슬라이드 자동 후퇴 → 다시 슬라이드를 당겨야 다음 발 장전
