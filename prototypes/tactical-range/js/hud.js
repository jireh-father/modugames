// ── HUD + 무기 교체 + 게임 화면 ──
import { state, W, H, HUD_H, CONTROLS_TOP, CONTROLS_BOTTOM, SLOT_H, resetGame, getTotalAmmo } from './game.js?v=12';
...
import { requestGyro, resetGyroRef, isGyroEnabled, isGyroSupported } from './gyro.js?v=12';
