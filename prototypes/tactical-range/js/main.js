...
import { W, H, state, isGameOver } from './game.js?v=5';
import { initJoystick, updateJoystick, drawJoystick } from './aiming.js?v=5';
import { drawRange, drawCrosshair } from './renderer.js?v=5';
