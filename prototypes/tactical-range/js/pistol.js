// ── 권총 시스템: 렌더링 + 조작 ──
import { state, W, H, CONTROLS_TOP, CONTROLS_BOTTOM, SLOT_H, JOYSTICK_W } from './game.js?v=11';
import { registerZone } from './input.js?v=11';
import { fireProjectile } from './projectiles.js?v=11';
import { playGunshot, playSlideRack, playMagOut, playMagIn, playBulletLoad } from './audio.js?v=11';
