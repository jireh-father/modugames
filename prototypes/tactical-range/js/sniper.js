// ── 저격총 시스템: 볼트액션 + 스코프 ──
import { state, W, H, CONTROLS_TOP, CONTROLS_BOTTOM, SLOT_H, JOYSTICK_W, RANGE_TOP, RANGE_BOTTOM } from './game.js?v=11';
...
import { getCrosshairScreen } from './renderer.js?v=11';
