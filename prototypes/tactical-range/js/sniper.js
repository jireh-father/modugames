// ── 저격총 시스템: 볼트액션 + 스코프 ──
import { state, W, H, CONTROLS_TOP, CONTROLS_BOTTOM, SLOT_H, JOYSTICK_W, RANGE_TOP, RANGE_BOTTOM } from './game.js?v=12';
import { registerZone } from './input.js?v=12';
import { fireProjectile } from './projectiles.js?v=12';
import { playSniperShot, playSniperBoltUp, playSniperBoltDown, playSniperLoad, playScopeZoom } from './audio.js?v=12';
import { spawnParticles } from './particles.js?v=12';
import { getCrosshairScreen } from './renderer.js?v=12';
