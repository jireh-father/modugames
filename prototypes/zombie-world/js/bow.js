...
import { state, W, H, CONTROLS_TOP, CONTROLS_BOTTOM, SLOT_H, ITEM_BAR_H, FIELD_TOP, TOWER_Y, getFireOrigin } from './game.js?v=18';
import { registerZone } from './input.js?v=18';
import { fireProjectile } from './projectiles.js?v=18';
import { playBowDraw, playBowRelease, playArrowNock, playArrowPick } from './audio.js?v=18';
