// ── 화염방사기 시스템: 연료 + 지속 발사 ──
import { state, W, CONTROLS_TOP, CONTROLS_BOTTOM, SLOT_H, ITEM_BAR_H, TOWER_Y, emitSound, getFireOrigin } from './game.js?v=311';
import { registerZone } from './input.js?v=311';
import { spawnParticles } from './particles.js?v=311';
import { playFlameLoop, playFlameStop } from './audio.js?v=311';
