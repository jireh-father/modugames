...
import { state, W, H, HUD_H, CONTROLS_TOP, CONTROLS_BOTTOM, SLOT_H, ITEM_BAR_H, resetGame, getTotalAmmo } from './game.js?v=9';
import { registerZone } from './input.js?v=9';
import { playStart, playGameOver, playNewRecord, playUIPause, playUIResume, playUIClick, playWeaponSwitch } from './audio.js?v=9';
import { requestGyro, resetGyroRef, isGyroEnabled } from './gyro.js?v=9';
