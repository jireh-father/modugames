...
import { initJoystick, updateJoystick, drawJoystick } from './aiming.js?v=1';
import { drawRange, drawCrosshair } from './renderer.js?v=1';
...
import { updateTargets, checkHits, drawTargets, drawWaveBanner, getWaveClearBonus } from './targets.js?v=1';
import { tryDropItem, initItems, updateItems, drawItems } from './items.js?v=1';
import { updateParticles, drawParticles } from './particles.js?v=1';
import {
