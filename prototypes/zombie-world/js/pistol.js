// ── 권총 시스템: 렌더링 + 조작 ──
import { state, W, H, CONTROLS_TOP, CONTROLS_BOTTOM, SLOT_H, ITEM_BAR_H } from './game.js?v=19';
import { registerZone } from './input.js?v=19';
import { fireProjectile } from './projectiles.js?v=19';
import { playGunshot, playSlideRack, playMagOut, playMagIn, playBulletLoad } from './audio.js?v=19';
