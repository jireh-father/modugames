...
import { W, state, TOWER_Y, FIELD_TOP, FIELD_BOTTOM } from './game.js?v=13';
import { findPath, drawPathDebug } from './pathfinding.js?v=13';
import { collidesWithBuilding } from './buildings.js?v=13';
