// ── 2D 탑다운 발사체 시스템 ──
import { state, W, TOWER_Y, WEAPON_PROFILES, emitSound, getFireOrigin } from './game.js?v=311';
import { isInsideBuilding } from './buildings.js?v=311';
